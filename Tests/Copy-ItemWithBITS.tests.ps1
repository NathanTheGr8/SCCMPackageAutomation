...
# describes the function Copy-ItemWithBITS
Describe 'Copy-ItemWithBITS' {
  ...
  Context 'Running without arguments'   {
    ...
    It 'runs without errors' {
      ...
      # scriptblock (braces):
      { Copy-ItemWithBITS } | Should Throw
    }
    It 'does something' {
      # call function Copy-ItemWithBITS and pipe the result to an assertion
      # Example:
      # Copy-ItemWithBITS | Should Be 'Expected Output'
      # Hint: 
    ...
    It 'does not return anything'     {
      Copy-ItemWithBITS | Should BeNullOrEmpty 
    }
  }
}
